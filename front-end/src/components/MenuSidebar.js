...
function MenuSidebar(props) {
    ...
    return (
        <Component>
            ...
            <MenuPanel>
                <MenuSidebarButton num={1} setSelect={props.setSelect} selected={props.select === 1} name="대시보드" to={`/teams/${teamId}/dashboard`}>
            ...
            <MenuPanel>
                <MenuSidebarButton num={2} setSelect={props.setSelect} selected={props.select === 2} name="알 림" to={`/teams/${teamId}/notification`}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
                        <path
                ...
                <MenuSidebarButton num={3} setSelect={props.setSelect} selected={props.select === 3} name="프로필" to={`/teams/${teamId}/profile`}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
                        <path
                ...
                <MenuSidebarButton num={4} setSelect={props.setSelect} selected={props.select === 4} name="초 대" to={`/teams/${teamId}/invites`}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
                        <path
            ...
            <MenuPanel hide={teamId === "me"}>
                <MenuSidebarButton num={5} setSelect={props.setSelect} selected={props.select === 5} name="팀" to={`/teams/${teamId}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
                        <path
                ...
                <MenuSidebarButton num={6} setSelect={props.setSelect} selected={props.select === 6} name="인수인계" to={`/teams/${teamId}/handovers`}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
                        <path
                ...
                <MenuSidebarButton num={7} setSelect={props.setSelect} selected={props.select === 7} name="보고서" to={`/teams/${teamId}/reports`}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
                        <path
